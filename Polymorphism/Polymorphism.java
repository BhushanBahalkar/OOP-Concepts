...
// There are two types of polymorphsm 1.Compile-time polymorphism/Method
// Overloading/ Static polymorphism/ Early binding and
// 2.Run-time polymorphism/Method Overriding/ Dynamic method Dispatch/ Late
// binding.

// Here this program is the example of compile-time polymorphism as we can see
// in this program the method m1() is repeating in the same class
// but with different parameters

// Some features of C.T.P

// Compile time polymorphism allows you to define multiple method s in the same
// class with the same name but the different parameters lists.
// Compile time polymorphism is faster than runtime polymorphism because the
// method call is resolved at compile time, not during the execution time.
